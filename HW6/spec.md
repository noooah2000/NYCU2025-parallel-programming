...
- Correctness (75%): 25% for each of the three filters ( filter1.csv , filter2.csv , and filter3.csv ). The breakdown of the 25%: 10%: Your parallelized program passes the verification. 15%: The speedup over the serial version should be greater than 5.0.
...
| 140.113.215.195 | 37077, 37093, 37094 | {student_id} | {Provided by TA} |
...
- HW6_xxxxxxx.zip (root) kernel.cl hostFE.c url.txt
